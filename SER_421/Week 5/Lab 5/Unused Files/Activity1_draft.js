...
console.log(document.body.onload); ///This prints out the name of the function, which is an anonymous function.
...
console.log(document.getElementById("vidans2").innerHTML="");
